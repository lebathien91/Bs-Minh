...
const Loading = () => {
  return (
    <div className="fixed w-full h-full top-0 left-0 right-0 bottom-0 z-50 bg-white/70 flex justify-center">
      <div className="m-auto">
        <div className="w-[110px] h-[110px] relative">
          ...
          <div className="absolute top-0 left-0 w-full overflow-hidden animate-spark">
            <svg
              className="w-[110px] h-[110px]"
              fill="#0cb8b6"
              enableBackground="new 0 0 300.08 300.08"
