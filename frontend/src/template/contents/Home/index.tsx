    ...
    <section id="home">
        ...
        <div className="h-[820px] flex items-center justify-center flex-wrap overflow-hidden relative z-20">
          <div className="container">
            <h1 className="text-black text-7xl font-semibold">
              Take best quality <br /> treatment for Cardiology
            </h1>
            ...
            <button className="px-8 py-3 bg-primary rounded-md text-white font-bold">
              Appointment
            </button>
          </div>
      ...
      <section className="container mt-32">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="border hover:shadow-3xl hover:border-none rounded-md p-7 flex flex-col justify-center items-center">
            <div className="w-[90px] h-[90px] rounded-full flex justify-center items-center bg-[#6758f3]/10 mb-6">
              <svg
          ...
          <div className="border hover:shadow-3xl hover:border-none rounded-md p-7 flex flex-col justify-center items-center">
            <div className="w-[90px] h-[90px] rounded-full flex justify-center items-center bg-[#37af47]/10 mb-6">
              <svg
                className="w-[52px] h-[52px]"
                fill="#37af47"
          ...
          <div className="border hover:shadow-3xl hover:border-none rounded-md p-7 flex flex-col justify-center items-center">
            <div className="w-[90px] h-[90px] rounded-full flex justify-center items-center bg-[#e6492d]/10 mb-6">
              <svg
                className="w-[52px] h-[52px]"
                fill="#e6492d"
                version="1.1"
              ...
              >
                <g>
                  <g>
                    <g>
                      <path d="m256 38.397c5.522 0 10-4.477 10-10v-18.397c0-5.523-4.478-10-10-10-5.523 0-10 4.477-10 10v18.397c0 5.523 4.477 10 10 10z"></path>
                      <path d="m342.609 62.764c1.556.88 3.246 1.298 4.915 1.298 3.486 0 6.874-1.827 8.713-5.079l9.655-17.069c2.719-4.807 1.026-10.908-3.78-13.628-4.806-2.718-10.909-1.027-13.628 3.781l-9.655 17.069c-2.719 4.807-1.026 10.908 3.78 13.628z"></path>
                      <path d="m409.789 128.753c1.634 0 3.292-.401 4.823-1.247l18.457-10.187c4.835-2.668 6.592-8.752 3.923-13.587-2.669-4.836-8.754-6.592-13.587-3.923l-18.457 10.187c-4.835 2.668-6.592 8.752-3.923 13.587 1.824 3.304 5.241 5.17 8.764 5.17z"></path>
                      <path d="m455.027 199.147h-19.524c-5.522 0-10 4.477-10 10s4.478 10 10 10h19.524c5.522 0 10-4.477 10-10s-4.477-10-10-10z"></path>
                      <path d="m155.763 58.983c1.84 3.252 5.227 5.079 8.713 5.079 1.668 0 3.359-.418 4.915-1.298 4.807-2.719 6.499-8.82 3.78-13.627l-9.655-17.069c-2.721-4.808-8.821-6.499-13.628-3.781-4.807 2.719-6.499 8.82-3.78 13.628z"></path>
                      <path d="m78.931 117.319 18.457 10.187c1.532.846 3.188 1.247 4.823 1.247 3.523 0 6.94-1.867 8.764-5.17 2.669-4.835.912-10.918-3.923-13.587l-18.457-10.187c-4.835-2.668-10.918-.913-13.587 3.923-2.669 4.835-.912 10.918 3.923 13.587z"></path>
                      <path d="m76.497 219.147c5.522 0 10-4.477 10-10s-4.478-10-10-10h-19.524c-5.522 0-10 4.477-10 10s4.478 10 10 10z"></path>
                      <path d="m448.091 446.815h-24.502v-61.428c0-5.523-4.478-10-10-10h-20.807v-171.08c0-75.405-61.347-136.752-136.813-136.752-75.405 0-136.752 61.347-136.752 136.752v171.081h-20.806c-5.522 0-10 4.477-10 10v61.428h-24.502c-5.522 0-10 4.477-10 10v45.184c0 5.523 4.478 10 10 10h384.182c5.523 0 10-4.477 10-10v-45.185c0-5.522-4.478-10-10-10zm-308.873-242.508c0-64.377 52.375-116.752 116.813-116.752 64.377 0 116.752 52.374 116.752 116.752v171.081h-86.683v-94.379c14.468-9.871 23.231-26.229 23.231-44.02 0-29.396-23.924-53.311-53.331-53.311s-53.331 23.915-53.331 53.311c0 17.79 8.764 34.148 23.232 44.02v94.379h-86.683zm101.326 62.204c-11.025-5.781-17.875-17.093-17.875-29.522 0-18.368 14.952-33.311 33.331-33.311s33.331 14.943 33.331 33.311c0 12.43-6.85 23.742-17.875 29.522-3.293 1.727-5.356 5.138-5.356 8.856v100.02h-20.2v-100.02c0-3.719-2.063-7.13-5.356-8.856zm197.547 225.489h-364.182v-25.185h136.885c5.523 0 10-4.477 10-10s-4.477-10-10-10h-102.383v-51.428h295.178v51.428h-102.383c-5.522 0-10 4.477-10 10s4.478 10 10 10h136.885z"></path>
                      <path d="m265.42 452.99c-1.61-3.865-5.581-6.387-9.771-6.16-4.161.225-7.816 3.098-9.029 7.08-1.212 3.978.243 8.471 3.606 10.938 3.284 2.409 7.764 2.601 11.23.458 4.105-2.538 5.822-7.856 3.964-12.316z"></path>
                    </g>
                  </g>
                </g>
              </svg>
