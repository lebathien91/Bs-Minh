...
const Department = () => {
  ...
  return (
    <>
      <div id="department" className="container">
        <section className="mt-32">
          <div className="text-center">
            <h2 className="text-black text-4xl">Our department</h2>
          ...
          <div className="mt-12">
            <ul className="flex overflow-x-auto overflow-y-hidden pb-4">
              <li
                onClick={() => setTabsActive(1)}
                className={`flex-1 mx-2 rounded-md ${
                  tabsActive === 1 ? "bg-primary" : "bg-primary/10"
                }`}
              >
                <button
                  className={`relative flex flex-col justify-center items-center p-4 min-w-[120px] h-[110px] w-full before:content-[''] before:w-5 before:h-5 before:overflow-hidden before:rounded-b-md before:rounded-l-none before:bg-primary before:absolute before:rotate-45 before:transition-all before:duration-200 before:ease-linear ${
                    tabsActive === 1
                      ? "before:opacity-1 before:-bottom-[10px]"
                      : "before:opacity-0 before:bottom-1"
                  }`}
                >
                  <span
                    className={`w-12 h-12 ${
                      tabsActive === 1 ? "fill-white" : "fill-primary"
                    }`}
                  >
                    <svg
                  ...
                  <span
                    className={`mt-1 font-bold ${
                      tabsActive === 1 ? "text-white" : "text-black"
                    }`}
                  >
                    Crutches
                  </span>
              ...
              <li
                ...
                className={`flex-1 mx-2 rounded-md ${
                  tabsActive === 2 ? "bg-[#e6492d]" : "bg-[#e6492d]/10"
                }`}
              >
                <button
                  className={`relative flex flex-col justify-center items-center p-4 min-w-[120px] h-[110px] w-full before:content-[''] before:w-5 before:h-5 before:overflow-hidden before:rounded-b-md before:rounded-l-none before:bg-[#e6492d] before:absolute before:rotate-45 before:transition-all before:duration-200 before:ease-linear ${
                    tabsActive === 2
                      ? "before:opacity-1 before:-bottom-[10px]"
                      : "before:opacity-0 before:bottom-1"
                  }`}
                >
                  <span
                    className={`w-12 h-12 ${
                      tabsActive === 2 ? "fill-white" : "fill-[#e6492d]"
                    }`}
                  >
                    <svg
                      version="1.1"
                    ...
                    c32.166,0.062,58.226,26.122,58.288,58.288V168h16v-37.712C479.938,89.285,446.715,56.062,405.712,56z"
                      ...
                      <g>
                        <polygon points="186.344,218.344 172.688,232 152,232 152,248 168,248 168,264 184,264 184,243.312 197.656,229.656    "></polygon>
                      </g>
                      <g>
                        <polygon points="307.312,232 293.656,218.344 282.344,229.656 296,243.312 296,264 312,264 312,248 328,248 328,232    "></polygon>
                      </g>
                    </svg>
                  </span>
                  <span
                    className={`mt-1 font-bold ${
                      tabsActive === 2 ? "text-white" : "text-black"
                    }`}
                  >
                    X-ray
                  </span>
              ...
              <li
                ...
                className={`flex-1 mx-2 rounded-md ${
                  tabsActive === 3 ? "bg-[#37af47]" : "bg-[#37af47]/10"
                }`}
              >
                <button
                  className={`relative flex flex-col justify-center items-center p-4 min-w-[120px] h-[110px] w-full before:content-[''] before:w-5 before:h-5 before:overflow-hidden before:rounded-b-md before:rounded-l-none before:bg-[#37af47] before:absolute before:rotate-45 before:transition-all before:duration-200 before:ease-linear ${
                    tabsActive === 3
                      ? "before:opacity-1 before:-bottom-[10px]"
                      : "before:opacity-0 before:bottom-1"
                  }`}
                >
                  <span
                    className={`w-12 h-12 ${
                      tabsActive === 3 ? "fill-white" : "fill-[#37af47]"
                    }`}
                  >
                    <svg
                      enableBackground="new 0 0 512 512"
              ...
              <li
                ...
                className={`flex-1 mx-2 rounded-md ${
                  tabsActive === 4 ? "bg-[#1665d8]" : "bg-[#1665d8]/10"
                }`}
              >
                <button
                  className={`relative flex flex-col justify-center items-center p-4 min-w-[120px] h-[110px] w-full before:content-[''] before:w-5 before:h-5 before:overflow-hidden before:rounded-b-md before:rounded-l-none before:bg-[#1665d8] before:absolute before:rotate-45 before:transition-all before:duration-200 before:ease-linear ${
                    tabsActive === 4
                      ? "before:opacity-1 before:-bottom-[10px]"
                      : "before:opacity-0 before:bottom-1"
                  }`}
                >
                  <span
                    className={`w-12 h-12 ${
                      tabsActive === 4 ? "fill-white" : "fill-[#1665d8]"
                    }`}
                  >
                    <svg
              ...
              <li
                onClick={() => setTabsActive(5)}
                className={`flex-1 mx-2 rounded-md ${
                  tabsActive === 5 ? "bg-[#f6ab2f]" : "bg-[#f6ab2f]/10"
                }`}
              >
                <button
                  className={`relative flex flex-col justify-center items-center p-4 min-w-[120px] h-[110px] w-full before:content-[''] before:w-5 before:h-5 before:overflow-hidden before:rounded-b-md before:rounded-l-none before:bg-[#f6ab2f] before:absolute before:rotate-45 before:transition-all before:duration-200 before:ease-linear ${
                    tabsActive === 5
                      ? "before:opacity-1 before:-bottom-[10px]"
                      : "before:opacity-0 before:bottom-1"
                  }`}
                >
                  <span
                    className={`w-12 h-12 ${
                      tabsActive === 5 ? "fill-white" : "fill-[#f6ab2f]"
                    }`}
                  >
                    <svg
                      version="1.1"
                  ...
                  <span
                    className={`mt-1 font-bold ${
                      tabsActive === 5 ? "text-white" : "text-black"
                    }`}
                  >
                    Dental care
                  </span>
              ...
              <li
                onClick={() => setTabsActive(6)}
                className={`flex-1 mx-2 rounded-md ${
                  tabsActive === 6 ? "bg-[#9ea0a5]" : "bg-[#9ea0a5]/10"
                }`}
              >
                <button
                  className={`relative flex flex-col justify-center items-center p-4 min-w-[120px] h-[110px] w-full before:content-[''] before:w-5 before:h-5 before:overflow-hidden before:rounded-b-md before:rounded-l-none before:bg-[#9ea0a5] before:absolute before:rotate-45 before:transition-all before:duration-200 before:ease-linear ${
                    tabsActive === 6
                      ? "before:opacity-1 before:-bottom-[10px]"
                      : "before:opacity-0 before:bottom-1"
                  }`}
                >
                  <span
                    className={`w-12 h-12 ${
                      tabsActive === 6 ? "fill-white" : "fill-[#9ea0a5]"
                    }`}
                  >
                    <svg
                      version="1.1"
                  ...
                  <span
                    className={`mt-1 font-bold ${
                      tabsActive === 6 ? "text-white" : "text-black"
                    }`}
                  >
                    Neurology
                  </span>
            ...
            <div className="w-full px-2 mt-12">
              <div className={tabsActive === 1 ? "block" : "hidden"}>
                <div className="flex flex-col lg:flex-row items-center">
                  <div className="w-full lg:w-1/2 lg:pr-8">
                    <figure>
                      <img src="/assets/img/crutches.png" alt="img" />
                    </figure>
                  </div>
                  <div className="w-full lg:w-1/2 mt-8 lg:mt-0 lg:pl-8">
                    <h2 className="text-black text-4xl">
                      Welcome to our
                      <span className="text-primary"> Crutches</span>
                    </h2>
                    ...
                    <button className="py-2 px-6 rounded-md bg-primary font-bold text-white">
                      Read More
                    </button>
                  </div>
                </div>
              </div>
              <div className={tabsActive === 2 ? "block" : "hidden"}>
                <div className="flex flex-col lg:flex-row items-center">
                  <div className="w-full lg:w-1/2 lg:pr-8">
                    <figure>
                      <img src="/assets/img/xray.png" alt="img" />
                    </figure>
                  </div>
                  <div className="w-full lg:w-1/2 mt-8 lg:mt-0 lg:pl-8">
                    <h2 className="text-black text-4xl">
                      Welcome to our
                      <span className="text-primary"> X-ray</span>
                    </h2>
                    <p className="font-semibold text-lg text-black mt-2">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Magni nemo libero debitis vitae sapiente quos.
              ...
              <div className={tabsActive === 3 ? "block" : "hidden"}>
                <div className="flex flex-col lg:flex-row items-center">
                  <div className="w-full lg:w-1/2 lg:pr-8">
                    <figure>
                      <img src="/assets/img/pulmonary.png" alt="img" />
                    </figure>
                  </div>
                  <div className="w-full lg:w-1/2 mt-8 lg:mt-0 lg:pl-8">
                    <h2 className="text-black text-4xl">
                      Welcome to our
                      <span className="text-primary"> Pulmonary</span>
                    </h2>
                    <p className="font-semibold text-lg text-black mt-2">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Magni nemo libero debitis vitae sapiente quos.
              ...
              <div className={tabsActive === 4 ? "block" : "hidden"}>
                <div className="flex flex-col lg:flex-row items-center">
                  <div className="w-full lg:w-1/2 lg:pr-8">
                    <figure>
                      <img src="/assets/img/cardiology.png" alt="img" />
                    </figure>
                  </div>
                  <div className="w-full lg:w-1/2 mt-8 lg:mt-0 lg:pl-8">
                    <h2 className="text-black text-4xl">
              ...
              <div className={tabsActive === 5 ? "block" : "hidden"}>
                <div className="flex flex-col lg:flex-row items-center">
                  <div className="w-full lg:w-1/2 lg:pr-8">
                    <figure>
                      <img src="/assets/img/dental-care.png" alt="img" />
                    </figure>
                  </div>
                  <div className="w-full lg:w-1/2 mt-8 lg:mt-0 lg:pl-8">
                    <h2 className="text-black text-4xl">
                      Welcome to our
                      <span className="text-primary"> DentalCare</span>
                    </h2>
                    <p className="font-semibold text-lg text-black mt-2">
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                      Magni nemo libero debitis vitae sapiente quos.
              ...
              <div className={tabsActive === 6 ? "block" : "hidden"}>
                <div className="flex flex-col lg:flex-row items-center">
                  <div className="w-full lg:w-1/2 lg:pr-8">
                    <figure>
                      <img src="/assets/img/neurology.png" alt="img" />
                    </figure>
                  </div>
                  <div className="w-full lg:w-1/2 mt-8 lg:mt-0 lg:pl-8">
                    <h2 className="text-black text-4xl">
      ...
      <div className="bg-[#f9fafc] mt-16">
        <section className="pt-20 container">
          <div className="text-center">
            <h2 className="text-black text-4xl">Make an appointment</h2>
            <div className="w-[130px] mx-auto my-3 flex justify-center items-center">
              <div className="w-[42px] h-[2px] bg-primary"></div>
              <div className="mx-4 animate-rotateAnimation">
                <img src="/assets/img/4.png" alt="img" />
          ...
          <form method="POST">
            <div className="mt-12 px-4 md:px-24 flex flex-wrap flex-col lg:flex-row">
              <div className="w-full lg:w-1/2 px-3 mb-6">
                <label className="block font-semibold mb-1" htmlFor="full-name">
                  Full Name
                </label>
                <input
                  className="rounded-md w-full outline-none py-2 px-4 border border-gray-200 focus:border-primary"
              ...
              <div className="w-full lg:w-1/2 px-3 mb-6">
                ...
                >
                  ...
                  <option>Dr. Jhon Doe</option>
                  <option>Dr. Mak Roshi</option>
                  <option>Dr. Mohoshin Kabir</option>
                  <option>Dr. Nayon Borua</option>
                  <option>Dr. Rasel Islam</option>
                </select>
              </div>
              ...
              <div className="w-full px-3 mb-6">
                <button className="rounded-md py-2 px-6 bg-primary text-white font-bold">
                  Appointment
                </button>
              </div>
            </div>
