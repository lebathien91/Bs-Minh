    ...
    <>
      <div id="department" className="container">
        <section className="mt-32">
          <div className="text-center">
            <h2 className="text-black text-4xl">Các chuyên khoa</h2>
            ...
            <p className="text-center">
              Chúng tôi có đội ngũ bác sĩ của nhiều chuyên khoa.
              <br />
              Có kinh nghiệm nhiều năm trong chăm sóc và quản lý sức khoẻ tại
              nhà.
            </p>
          </div>
          ...
          <div className="mt-12">
            ...
            <div className="w-full px-2 mt-12">
              {departments.map((department) => (
                <div
                  className={tabsActive === department.id ? "block" : "hidden"}
                  key={department.id}
                >
                  <div className="flex flex-col lg:flex-row items-center">
                    ...
                    <div className="w-full lg:w-1/2 mt-8 lg:mt-0 lg:pl-8">
                      <h2 className="text-black text-4xl">
                        ...
                        <span className="text-primary">{department.title}</span>
                      </h2>
                      <p className="font-semibold text-lg text-black mt-2">
                        {department.description}
                      </p>
                      <p className="my-4">{department.body}</p>
      ...
      <div className="bg-[#f9fafc] mt-16">
        <section className="pt-20 container">
          <div className="text-center">
            <h2 className="text-black text-4xl">Đặt lịch hẹn</h2>
            <div className="w-[130px] mx-auto my-3 flex justify-center items-center">
              <div className="w-[42px] h-[2px] bg-primary"></div>
              <div className="mx-4 animate-rotateAnimation">
                <img src="/assets/img/4.png" alt="img" />
            ...
            <p className="text-center">
              Hãy liên hệ ngay với chúng tôi để đặt lịch hẹn nếu bạn có vấn đề
              về sức khoẻ.
              <br /> Chúng tôi sẽ liên hệ lại với bạn sớm nhất có thể.
            </p>
          </div>
          <form method="POST">
            <div className="mt-12 px-4 md:px-24 flex flex-wrap flex-col lg:flex-row">
              ...
              <div className="w-full px-3 mb-6">
                ...
                <textarea
                  className="rounded-md w-full outline-none py-2 px-4 border border-gray-200 focus:border-primary"
                  placeholder="Viết vài thứ vào đây..."
                  cols={30}
                  rows={5}
                  name="messenger"
                  id="messenger"
